...
function LaenderEditForm() {
    ...
    /* Hier werden die Daten des Laender von der API geladen. Der API-Call wird asynchron ausgeführt */
    const getData = async () => {
        /* Fehler abfangen */
        try{
            const res = await axios.get("https://emina.dnet.ch/laender/" + id);
    ...
    const updateData = async () => {
        ...
        try{
            const response = await axios.put("https://emina.dnet.ch/laender/" + id, json, config);
    ...
    return (
        ...
        <Form onSubmit={handleSubmit}>
            <Form.Group className="mb-3" controlId="formLandLand">
