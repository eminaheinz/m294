...
function NoteAddForm() {
    ...
    const updateData = async () => {
        ...
        try{
            const response = await axios.put("https://emina.dnet.ch/lehrbetriebe_lernende/" + id, json, config);
    ...
    return (
        ...
        <Alert show={showSuccess} variant="success">
            <p>
              Daten wurde erfolgreich aktualisiert.
            </p>
        </Alert>
        ...
        <Form onSubmit={handleSubmit}>
            <Form.Group className="mb-3" controlId="formKursDauer">
                ...
                <Form.Control type="text" name="beruf" placeholder="Beruf" defaultValue={loadedValues.beruf} onChange={handleChange}/>
            </Form.Group>
            <Form.Group className="mb-3" controlId="formKursDauer">
                <Form.Label>Start</Form.Label>
                <Form.Control type="date" name="start" placeholder="Start" defaultValue={loadedValues.start} onChange={handleChange}/>
            </Form.Group>
            <Form.Group className="mb-3" controlId="formKursDauer">
                <Form.Label>Ende</Form.Label>
                <Form.Control type="date" name="ende" placeholder="Ende" defaultValue={loadedValues.ende} onChange={handleChange}/>
            </Form.Group>
