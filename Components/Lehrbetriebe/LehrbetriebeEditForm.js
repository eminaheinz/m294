...
function LehrbetriebenEditForm() {
    ...
    /* Hier werden die Daten des Lehrbetrieben von der API geladen. Der API-Call wird asynchron ausgeführt */
    const getData = async () => {
        /* Fehler abfangen */
        try{
            const res = await axios.get("https://emina.dnet.ch/lehrbetriebe/" + id);
    ...
    const updateData = async () => {
        ...
        try{
            const response = await axios.put("https://emina.dnet.ch/lehrbetriebe/" + id, json, config);
    ...
    return (
        ...
        <Form.Group className="mb-3" controlId="fromLehrbetriebInhalt">
            ...
            <Form.Group className="mb-3" controlId="fromLehrbetriebLehrbetrieb">
                <Form.Label>PLZ</Form.Label>
                <Form.Control  name="plz" type="text" placeholder="PLZ" defaultValue={loadedValues.plz} onChange={handleChange}/>
            </Form.Group>
            <Form.Group className="mb-3" controlId="fromLehrbetriebStartdatum">
...
export default LehrbetriebenEditForm;
