...
function LernendeEditForm() {
    ...
    const getData = async () => {
        /* Fehler abfangen */
        try{
            const res = await axios.get("https://emina.dnet.ch/lernende/" + id);
    ...
    const updateData = async () => {
        ...
        try{
            const response = await axios.put("https://emina.dnet.ch/lernende/" + id, json, config);
    ...
    return (
        ...
        <Form onSubmit={handleSubmit}>
            ...
            <Form.Group className="mb-3" controlId="fromLernendeLernende">
                <Form.Label>PLZ</Form.Label>
                <Form.Control  name="plz" type="text" placeholder="PLZ" defaultValue={loadedValues.plz} onChange={handleChange}/>
            </Form.Group>
            <Form.Group className="mb-3" controlId="fromLernendeStartdatum">
            ...
            <Form.Group className="mb-3" controlId="fromLernendeEmailPrivat">
                ...
                <Form.Control  type="text" name="email_privat" placeholder="Email Privat" defaultValue={loadedValues.email_privat} onChange={handleChange}/>
            </Form.Group>
            <Form.Group className="mb-3" controlId="fromLernendeDauer">
